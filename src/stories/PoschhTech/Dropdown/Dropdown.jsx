...
export const Dropdown = () => {
  return (
    <Popover className="flex items-center  mx-4 h-[600px] ">
      <Popover.Button className="inline-flex items-center gap-x-1 bg-[#212121] mx-auto text-md font-semibold h-[50px] w-[100px] leading-6 text-[#E5E1E9]">
      ...
      >
        <Popover.Panel className="absolute left-1/2 z-10 mt-5 flex w-screen max-w-max -translate-x-1/2 px-4">
          <div className="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-[#141318] text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
            <div className="p-4">
              {solutions.map((item) => (
