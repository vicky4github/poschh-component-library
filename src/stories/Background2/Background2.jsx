...
export const Background2 = (bgColor) => (
  <div className="container">
    <Scene style={{ borderRadius: 20 }}  bgColor={bgColor} />
  </div>
)
...
function Scene(props) {
  ...
  return (
    <Canvas onClick={click} shadows dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 15], fov: 17.5, near: 1, far: 20 }} {...props}>
      {/* debugger */}
      <color attach="background" args={[props.bgColor.bgColor]} />
